...
csv_files = glob.glob('../data/raw2/*.csv')
...
for file in csv_files:
    ...
    output_file = os.path.join('../data/processed2', os.path.basename(file))
...
combine_processed_csvs('../data/processed2', '../data/datasheet_new.csv')
